...
// returned if failed.
func (obj *SObject) Get(ctx context.Context, id ...string) *SObject {
	if obj.Type() == "" || obj.client() == nil {
		// Sanity check.
		return nil
	}
...
func (obj *SObject) Create(ctx context.Context) *SObject {
	if obj.Type() == "" || obj.client() == nil {
		// Sanity check.
		return nil
	}
...
// ID is required.
func (obj *SObject) Update(ctx context.Context) *SObject {
...
func (obj *SObject) Upsert(ctx context.Context) *SObject {
